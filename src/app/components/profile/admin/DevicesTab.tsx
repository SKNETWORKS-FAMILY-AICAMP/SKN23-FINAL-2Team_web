              ...
              {!searchOrgTerm ? (
                ...
                <>
                  ...
                  {filteredOrgs.length === 0 && (
                    <div className="px-6 py-10 text-center text-zinc-600 text-[10px] font-bold uppercase tracking-widest">
                      일치하는 기업이 없습니다.
                    </div>
                  )}
                </>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 gap-6">
              ...
              >
                <div className="flex items-center gap-6 mb-8">
                  ...
                  <div>
                    ...
                    <p className="text-[9px] text-blue-500 font-black uppercase tracking-[0.25em]">{device.company_name}</p>
                  </div>
                </div>
                ...
                <div className="space-y-4 mb-10 flex-1">
                  <div className="flex items-center justify-between p-4 bg-white/2 rounded-2xl border border-white/5 hover:bg-white/5 transition-all">
                     <div className="flex items-center gap-3 text-zinc-500">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-widest italic">Identity</span>
                     </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-white/2 rounded-2xl border border-white/5 hover:bg-white/5 transition-all">
                     <div className="flex items-center gap-3 text-zinc-500">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-widest italic">Node ID</span>
                     </div>
                     <span className="text-[10px] text-zinc-500 font-mono font-bold">{device.machine_id.substring(0, 12)}...</span>
                  </div>
                </div>
          ...
          {devices.length === 0 && !isLoading && (
            <div className="col-span-full text-center py-32 bg-zinc-900/10 rounded-[48px] border border-dashed border-white/10 flex flex-col items-center">
               ...
               <p className="text-zinc-600 font-black uppercase tracking-[0.2em] text-sm italic">No Active Terminals Detected for this Query.</p>
            </div>
          )}
        </div>
      )}
